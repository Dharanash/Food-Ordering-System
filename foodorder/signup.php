...
<style>
	...
	input[type=text], input[type=text], input[type=text], textarea, input[type=email], input[type=password]{
		width: 100%;
		box-sizing: border-box;
		padding: 12px 5px;
...
<div class="container-fluid wrap">
	...
	<form action="" id="signup-frm">
			...
			<textarea cols="30" rows="3" name="address" placeholder="Address" required></textarea>
